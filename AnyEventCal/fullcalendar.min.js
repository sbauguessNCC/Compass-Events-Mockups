...
!(function (t) {
    ...
    function ut(n, i, r) {
        ...
        return (
            e.isMoment(u) || U(u) || void 0 === u
                ...
                : ((s = !1),
                  (o = !1),
                  c ? (Ut.test(u) ? ((u += "-01"), (n = [u]), (s = !0), (o = !0)) : (l = jt.exec(u)) && ((s = !l[5]), (o = !0))) : t.isArray(u) && (o = !0),
    ...
    function Mt(e, n) {
        ...
        function r() {
            ...
            (p = e.options.theme ? "ui" : "fc"),
                i ? (g ? g.empty() : (g = this.el = t("<div class='fc-toolbar " + n.extraClasses + "'/>")), g.append(o("left")).append(o("right")).append(o("center")).append('<div class="fc-clear"/>')) : s();
        }
        function s() {
                            ...
                            "title" == i
                                ...
                                : ((r = (e.options.customButtons || {})[i])
                                  ...
                                  a &&
                                      ...
                                      (m = t('<button type="button" class="' + g.join(" ") + '">' + f + "</button>")
                                          .click(function (t) {
    ...
    function Bt(n, i) {
        ...
        function u(e, n) {
            ...
            var i = Q && e && Q.type !== e;
            i && (F(), c()),
                !Q && e && ((Q = _.view = et[e] || (et[e] = _.instantiateView(e))), Q.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo(q)), W.proxyCall("activateButton", e)),
                Q && ((J = Q.massageCurrentDate(J)), (Q.isDateSet && J >= Q.intervalStart && J < Q.intervalEnd) || (a() && (n && Q.captureInitialScroll(n), Q.setDate(J, n), n && Q.releaseScroll(), D()))),
                i && z(),
                nt--;
        }
        function c() {
            ...
            (_.moment = function () {
                ...
                return (
                    "local" === _.options.timezone
                        ? ((t = Ot.moment.apply(null, arguments)), t.hasTime() && t.local())
                        : (t = "UTC" === _.options.timezone ? Ot.moment.utc.apply(null, arguments) : Ot.moment.parseZone.apply(null, arguments)),
                    r(t),
                    t
                );
            }),
    ...
    function zt() {
        ...
        function P(t) {
            null == t.allDay && (t.allDay = !(t.start.hasTime() || (t.end && t.end.hasTime()))),
                t.allDay ? (t.start.stripTime(), t.end && t.end.stripTime()) : (t.start.hasTime() || (t.start = U.applyTimezone(t.start.time(0))), t.end && !t.end.hasTime() && (t.end = U.applyTimezone(t.end.time(0))));
        }
        function _(e, n, i) {
            var r,
                s,
    ...
    var Jt = (Ot.EmitterMixin = {
        ...
        ie = (Ot.DragListener = ct.extend(te, {
            ...
            bindHandlers: function () {
                var t = se.get();
                this.isTouch ? this.listenTo(t, { touchmove: this.handleTouchMove, touchend: this.endInteraction, scroll: this.handleTouchScroll }) : this.listenTo(t, { mousemove: this.handleMouseMove, mouseup: this.endInteraction }),
        ...
        le = (Ot.Grid = ct.extend(te, {
            ...
            getDayClasses: function (t, e) {
                ...
                return (
                    ...
                    t.isSame(i, "day") ? (r.push("fc-today"), e !== !0 && r.push(n.highlightStateClass)) : t < i ? r.push("fc-past") : r.push("fc-future"),
                    r
                );
            },
        }));
    le.mixin({
        ...
        buildBusinessHourEvents: function (e, n) {
            ...
            return null == n && (n = r.options.businessHours), (i = r.computeBusinessHourEvents(e, n)), !i.length && n && (i = [t.extend({}, we, { start: this.view.end, end: this.view.end, dow: null })]), i;
        },
        ...
        handleSegTouchStart: function (t, e) {
            ...
            o && a && (u = this.startSegResize(t, e)),
                u || (!l && !a) || ((i = r.opt("eventLongPressDelay")), null == i && (i = r.opt("longPressDelay")), (n = l ? this.buildSegDragListener(t) : this.buildSegSelectListener(t)), n.startInteraction(e, { delay: o ? 0 : i }));
        },
        ...
        buildSegDragListener: function (t) {
            ...
            var d = (this.segDragListener = new re(l, {
                ...
                interactionStart: function (i) {
                    (t.component = r),
                        (e = !1),
                        (n = new oe(t.el, { additionalClass: "fc-dragging", parentEl: l.el, opacity: d.isTouch ? null : l.opt("dragOpacity"), revertDuration: l.opt("dragRevertDuration"), zIndex: 2 })),
                        n.hide(),
                        n.start(i);
                },
        ...
        computeEventDrop: function (t, e, n) {
            ...
            return (
                o.hasTime() === l.hasTime()
                    ? ((i = this.diffDates(l, o)), n.allDay && W(i) ? ((r = { start: n.start.clone(), end: s.getEventEnd(n), allDay: !1 }), s.normalizeEventTimes(r)) : (r = mt(n)), r.start.add(i), r.end && r.end.add(i))
                ...
                h = (this.segResizeListener = new re(this, {
                    ...
                    hitOver: function (n, o, u) {
                        ...
                        (i = e ? r.computeEventStartResize(h, f, c) : r.computeEventEndResize(h, f, c)),
                            i && (a.isEventSpanAllowed(r.eventToSpan(i), c) ? i.start.isSame(c.start.clone().stripZone()) && i.end.isSame(d.clone().stripZone()) && (i = null) : (s(), (i = null))),
        ...
        eventsToSegs: function (e, n) {
            ...
            return (
                t.each(r, function (t, e) {
                    ...
                    if (St(e[0])) for (o = i.invertRanges(o), r = 0; r < o.length; r++) s.push.apply(s, i.eventRangeToSegs(o[r], e[0], n));
        ...
        invertRanges: function (t) {
            var e,
                ...
                o = [],
                l = r;
            for (t.sort(bt), e = 0; e < t.length; e++) (n = t[e]), n.start > l && o.push({ start: l, end: n.start }), (l = n.end);
    ...
    var ae = (Ot.DayTableMixin = {
            ...
            renderHeadDateCellHtml: function (t, e, n) {
                ...
                return (
                    1 === this.rowCnt ? (r = r.concat(this.getDayClasses(t, !0))) : r.push("fc-" + _t[t.day()]),
                    '<th class="' +
                        r.join(" ") +
                        '"' +
            ...
            renderDates: function (t) {
                ...
                for (
                    this.el.html(o),
                        ...
                        this.rowCoordCache = new ne({ els: this.rowEls, isVertical: !0 }),
                        this.colCoordCache = new ne({ els: this.cellEls.slice(0, this.colCnt), isHorizontal: !0 }),
                        e = 0;
                    e < r;
                    e++
                )
    ...
    ue.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                ...
                t.isStart && ((n = this.getEventTimeText(s)), n && (d = '<span class="fc-time">' + tt(n) + "</span>")),
            ...
            renderMoreLink: function (e, n, i) {
                ...
                return t('<a class="fc-more"/>')
                    ...
                    .on("click", function (o) {
                        ...
                        "function" == typeof l && (l = s.publiclyTrigger("eventLimitClick", null, { date: a, dayEl: c, moreEl: u, segs: h, hiddenSegs: f }, o)),
    ...
    var ce = (Ot.TimeGrid = le.extend(ae, {
        ...
        renderDates: function () {
            this.el.html(this.renderHtml()),
                ...
                (this.colCoordCache = new ne({ els: this.colEls, isHorizontal: !0 })),
                (this.slatCoordCache = new ne({ els: this.slatEls, isVertical: !0 })),
    ...
    var de = (Ot.View = ct.extend(Jt, te, {
            ...
            computeTitle: function () {
                var t, e;
                return (
                    "year" === this.intervalUnit || "month" === this.intervalUnit ? ((t = this.intervalStart), (e = this.intervalEnd)) : ((t = this.start), (e = this.end)),
                    this.formatRange({ start: this.calendar.applyTimezone(t), end: this.calendar.applyTimezone(e) }, this.opt("titleFormat") || this.computeTitleFormat(), this.opt("titleRangeSeparator"))
                );
            },
    ...
    var fe = (Ot.Calendar = ct.extend({
        ...
        buildViewSpec: function (t) {
            ...
            return (
                ...
                (i.type = t),
                !!i.class &&
                    (s && ((s = e.duration(s)), s.valueOf() && ((i.duration = s), (o = A(s)), 1 === s.as(o) && ((i.singleUnit = o), c.unshift(l[o] || {})))),
                    (i.defaults = n(u)),
                    (i.overrides = n(c)),
    ...
    var we = { id: "_fcBusinessHours", start: "09:00", end: "17:00", dow: [1, 2, 3, 4, 5], rendering: "inverse-background" };
    ...
    (At.basic = { class: Ee }), (At.basicDay = { type: "basic", duration: { days: 1 } }), (At.basicWeek = { type: "basic", duration: { weeks: 1 } }), (At.month = { class: De, duration: { months: 1 }, defaults: { fixedWeekCount: !0 } });
    var Te = (Ot.AgendaView = de.extend({
            ...
            setHeight: function (t, e) {
                ...
                this.bottomRuleEl.hide(),
                    ...
                    this.dayGrid && (this.dayGrid.removeSegPopover(), (n = this.opt("eventLimit")), n && "number" != typeof n && (n = xe), n && this.dayGrid.limitRows(n)),
                    e ||
        ...
        xe = 5,
        Re = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
    (At.agenda = { class: Te, defaults: { allDaySlot: !0, slotDuration: "00:30:00", minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0 } }),
    ...
    return (
        (At.list = { class: Ie, buttonTextKey: "list", defaults: { buttonText: "list", listDayFormat: "LL", noEventsMessage: "No events to display" } }),
        (At.listDay = { type: "list", duration: { days: 1 }, defaults: { listDayFormat: "dddd" } }),
        (At.listWeek = { type: "list", duration: { weeks: 1 }, defaults: { listDayFormat: "dddd", listDayAltFormat: "LL" } }),
        (At.listMonth = { type: "list", duration: { month: 1 }, defaults: { listDayAltFormat: "dddd" } }),
        (At.listYear = { type: "list", duration: { year: 1 }, defaults: { listDayAltFormat: "dddd" } }),
        Ot
    );
});
//# sourceURL=https://ncc.my.site.com/Compass/resource/1695437390000/AnyEventCal/fullcalendar.min.js
